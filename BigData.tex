...
\section{Big Data} \label{sec:big-data}
	...
	También podemos considerar Big Data como parte del área ciencia de datos (data science). Esta es una temática emergente que aglutina todas las áreas científicas que tratan de extraer conocimiento de los datos.
