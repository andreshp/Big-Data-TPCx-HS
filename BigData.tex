...
\section{Benchmarks: TPCx-HS} \label{sec:tpcx-hs}
	...
	\subsection{Carga de trabajo de TPCx-HS}
		...
		\begin{itemize}
			...
			\item HSSort: es un programa que ordena los datos según un orden total. Está basado en el algoritmo de ordenación Terasort.
