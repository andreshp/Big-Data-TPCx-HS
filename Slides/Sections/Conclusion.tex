...
\section{Conclusión}
	...
	\begin{frame}{Conclusión}
		...
		\begin{tikzpicture}
		\node [fill=Grandis!80, circle,inner sep=2pt, text width=2.35cm, align=center] (ise) {Ingeniería de servidores};
		\node [fill=TurkishRose!80, circle,inner sep=2pt, text width=2.35cm, align=center, right= 2.2cm of $(ise)$] (pd) {Programación distribuida};
		\node [fill=ChetwodeBlue!80, circle, inner sep=2pt, text width=2.35cm, align=center, above = 20mm of $(ise)!0.5!(pd)$] (cd) {Ciencia de Datos};
		\node [fill=Jaguar!85, circle, inner sep=2pt, text width=2.5cm, align=center, below = 6mm of $(cd)$] (bd) {\color{white}{\textbf{Big Data}}};
		\end{tikzpicture}
