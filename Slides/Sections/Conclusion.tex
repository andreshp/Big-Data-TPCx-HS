...
\section{Conclusión}
	...
	\begin{frame}{Conclusión}
		...
		\begin{tikzpicture}
		\node [fill=Grandis!80, circle,inner sep=2pt, text width=2.35cm, align=center] (vel) {Velocidad};
		\node [fill=TurkishRose!80, circle,inner sep=2pt, text width=2.35cm, align=center, right= 1.6cm of $(vel)$] (var) {Variedad};
		\node [fill=ChetwodeBlue!80, circle, inner sep=2pt, text width=2.35cm, align=center, above = 9mm of $(vel)!0.5!(var)$] (vol) {Volumen};
		\node [fill=Jaguar!85, circle, inner sep=2pt, text width=2.5cm, align=center, below = 4mm of $(vol)$] (bd) {\color{white}{\textbf{Big Data}}};
		\end{tikzpicture}
